...
// Project related.
var project                 = 'Timberjack'; // Project Name.
var projectURL              = 'web.dev'; // Project URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'TIMBERJACK'; // Your textdomain here.
var destFile                = 'TIMBERJACK.pot'; // Name of the transalation file.
var packageName             = 'TIMBERJACK'; // Package name.
var bugReport               = 'https://github.com/magluca/timberjack'; // Where can users report bugs.
var lastTranslator          = 'Magnus Luca <timberjack@webværk.com>'; // Last translator Email ID.
//var team                    = 'WPTie <your_email@email.com>'; // Team's Email ID.
var translatePath           = './languages' // Where to save the translation files.

// Style related.
var styleSRC                = './assets/styles/scss/main.scss'; // Path to main .scss file.
var styleDestination        = './assets/styles/'; // Path to place the compiled CSS file.
